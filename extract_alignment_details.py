...
start = time.time()
short_samfile = pysam.AlignmentFile('aln-se.sam', 'r' )
long_samfile = pysam.AlignmentFile('minimapalignment.sam','r')


long_data = {'qname':[],'query':[],'qlength':[],'qalign_start':[],'qalign_end':[],'ref_id':[],'ref_name':[],'ref_start':[],'ref_end':[],'map_qual':[]}
short_data = {'qname':[],'query':[],'qlength':[],'qalign_start':[],'qalign_end':[],'ref_id':[],'ref_name':[],'ref_start':[],'ref_end':[],'map_qual':[]}
